...
def upgrade() -> None:
    ...
    with op.batch_alter_table('alerts', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('deduplication_key', sa.String(), nullable=True))
        batch_op.add_column(sa.Column('snoozed_until', sa.DateTime(), nullable=True))
        batch_op.add_column(sa.Column('snooze_reason', sa.String(), nullable=True))
        ...
        batch_op.add_column(sa.Column('occurrence_count', sa.Integer(), nullable=False, server_default='1'))
        batch_op.create_index(batch_op.f('ix_alerts_deduplication_key'), ['deduplication_key'], unique=False)
        batch_op.create_foreign_key('fk_alerts_rules', 'rules', ['rule_id'], ['id'], ondelete='SET NULL')
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('alerts', schema=None) as batch_op:
        batch_op.drop_constraint('fk_alerts_rules', type_='foreignkey')
        batch_op.drop_index(batch_op.f('ix_alerts_deduplication_key'))
        batch_op.drop_column('occurrence_count')
        batch_op.drop_column('assigned_to')
        batch_op.drop_column('acknowledged_at')
        batch_op.drop_column('resolved_at')
        batch_op.drop_column('snooze_reason')
