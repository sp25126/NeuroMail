            ...
            if (isSlashCommand) {
                ...
                if (toolCalls.length > 0) {
                    ...
                    return {
                        ...
                        toolCalls: [],
                        toolResults: [],
                        metadata: { traceId, executionTimeMs: Date.now() - startTime, tokensUsed: 0, toolsExecuted: 0 }
                    };
                }
                ...
                return {
                    ...
                    toolCalls,
                    toolResults,
                    metadata: { traceId, executionTimeMs: Date.now() - startTime, tokensUsed: 0, toolsExecuted: 1 }
                };
            }
