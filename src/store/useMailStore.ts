...
interface MailState {
    ...
    view: 'inbox' | 'thread' | 'compose' | 'settings'
    ...
    clearFilter: () => void
    setView: (view: 'inbox' | 'thread' | 'compose' | 'settings') => void
...
export const useMailStore = create<MailState>((set, get) => ({
    ...
    setFolder: (folder) => {
        ...
        set({ currentFolder: folder, searchQuery: '', activeFilter: null, view: 'inbox', selectedThreadId: null })
        get().fetchThreads()
    },
